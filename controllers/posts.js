...
exports.saveComment = function(req, res){
    ...
    var d = new Date();
    var comment_ = req.param('comment').replace(/\n/g, '<br/>')

    comments.saveComment(req.param('id'), req.param('author_name'), req.param('author_email'), comment_, function(comment) {
        bayeux.getClient().publish('/' + req.param('id') + '/comments/bayeux', {
            ...
            gravatar_url: get_gravatar(req.param('author_email'))
        });
